    ...
    return (
        <div className="CreateCollectiblePage">
            <div>
                ...
                <input id="attributename" data-testid="attributename" type="text" placeholder="Collectible Name" value={attributename}
                       onChange={(event) => setattributename(event.target.value)}/>
                <input id="image" data-testid="image" type="text" placeholder="image url" value={imageid}
                       onChange={(event) => setimageid(event.target.value)}/>
                <button id="btncreate" data-testid="btncreate" onClick={AddCollectible}>Create</button>
            </div>
        </div>
    );
}
